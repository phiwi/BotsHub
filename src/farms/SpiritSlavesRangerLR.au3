...
Global Const $SSRL_YOU_ARE_ALL_WEAKLINGS = 2
Global Const $SSRL_LIGHTNING_REFLEXES = 3
...
Global Const $SSRL_SKILLS_ARRAY = [$SSRL_ESCAPE, $SSRL_YOU_ARE_ALL_WEAKLINGS, $SSRL_LIGHTNING_REFLEXES, $SSRL_GRENTHS_AURA, $SSRL_CRIPPLING_VICTORY, $SSRL_REAP_IMPURITIES, $SSRL_MENTAL_BLOCK, $SSRL_DWARVEN_STABILITY]
Global Const $SSRL_SKILLS_COSTS_ARRAY = [5, 5, 10, 10, 6, 5, 10, 5]
...
Func SpiritSlavesRangerLRFarm()
	If Not $spirit_slaves_ranger_lr_farm_setup And SetupSpiritSlavesRangerLRFarm() == $FAIL Then Return $PAUSE
	Return SpiritSlavesRangerLRFarmLoop()
EndFunc
...
Func SpiritSlavesRangerLRMaintainDefensiveUpkeep()
	...
	If IsRecharged($SSRL_LIGHTNING_REFLEXES) And GetEnergy() >= $SSRL_SKILL_COSTS_MAP[$SSRL_LIGHTNING_REFLEXES] Then
		If Not $hasLR Then UseSkillEx($SSRL_LIGHTNING_REFLEXES)
