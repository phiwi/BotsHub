...
Global Const $FROGGY_ELEMENTALIST_SKILLBAR = 'OgBCoMz0uYbZuYOzuAdjQ0YF' ; 4 Ele Fire
...
Global Const $FROGGY_ASSASSIN_HERO_GWEN_TEMPLATE = 'OQNEAawD2C9CwBhAmnRCMBkBgGB'
Global Const $FROGGY_ASSASSIN_HERO_MOW_TEMPLATE = 'OANDQjxHT5BJgVCNidCQCDCtEA'
Global Const $FROGGY_ASSASSIN_HERO_OLIAS_TEMPLATE = 'OABCUsx0SVVAagC4WYV1XQSF'
Global Const $FROGGY_ASSASSIN_HERO_DUNKORO_TEMPLATE = 'OwUTMw2CXihY6bj4upBMjoHIDAA'
Global Const $FROGGY_ASSASSIN_HERO_NORGU_TEMPLATE = 'OQdTAYB7H6Hgnit5NTR00ZHIHAA'
Global Const $FROGGY_ASSASSIN_HERO_RAZAH_TEMPLATE = 'OQREAsIjU8MV5aI/ewPgnWFQDA' ; ESurge
Global Const $FROGGY_ASSASSIN_HERO_LIVIA_TEMPLATE = 'OABDUslXSLVUBVVWClBbh1BKgA' ; Bone Fiends + Curses
Global Const $FROGGY_ASSASSIN_HERO_ZHED_TEMPLATE = 'OgVEMYyqw6k6cFZjZxXdraAMBA'
Global Const $FROGGY_ASSASSIN_VEKK_DUNKORO_TEMPLATE = 'OgBCkMzzOsHy0QFbjlIsIVA'
...
;~ Global Const $FROGGY_ELEMENTALIST_HERO_GWEN_TEMPLATE = 'OQhkAkB6gJq0LACIHUeGJQPVGAGD' ; Inep + Splinter
...
Global Const $FROGGY_ELEMENTALIST_HERO_NORGU_TEMPLATE = 'OQNDAsw9Mwtcw0TwZ60AXA0I' ; 4 Ele Stolen
...
Global Const $FROGGY_ELEMENTALIST_HERO_XANDRA_TEMPLATE = 'OACjAyhG5OYzwp17xBNRuTOnJA' ; 4 Ele ST
Global Const $FROGGY_ELEMENTALIST_HERO_TAHLKORA_TEMPLATE = 'OwAS0YIPMkp/G5uZ0yISkLC' ; 4 Ele UA
...
;~ Global Const $FROGGY_ELEMENTALIST_HERO_ZHED_TEMPLATE = 'OgljgwMqJOkDvx3QHmD9x14wBA' ; 4 Ele Air TC
Global Const $FROGGY_ELEMENTALIST_HERO_ZHED_TEMPLATE = 'OgljgwMqJSAaeDKNLg5Q+Y1YhDA' ; 4 Ele Air IL
Global Const $FROGGY_ELEMENTALIST_HERO_JIN_TEMPLATE = 'OgUUY5LijsSuS4G/GfGghQH0GOBA'

Global $froggy_max_dp_members_count = 0
Global Const $FROGGY_ELEMENTALIST_HERO_SOUSUKE_TEMPLATE = 'OgVCsMzUKz0Ak4hz6Q6QRF0A' ; 4 Ele Water
Global Const $FROGGY_ELEMENTALIST_HERO_OLIAS_TEMPLATE = 'OAVEMEdFbKdHcUNFoAWUhGsFOCB' ; 4 Ele MM BiP
Global Const $FROGGY_ELEMENTALIST_HERO_LIVIA_TEMPLATE = 'OABDUslXSLVUBVVWClBbh2BKgA' ; Bone Fiends + Curses
Global Const $FROGGY_ELEMENTALIST_HERO_OGDEN_TEMPLATE = 'Owkj4sQqpO+sqPe9iQ9dJ7YfMA' ; RoJ + Never Surrender
Global Const $FROGGY_ELEMENTALIST_HERO_VEKK_TEMPLATE = 'OgBCkMz0OUPETDqw2wSkjYqA' ; 4 Ele Earth
Global Const $FROGGY_ELEMENTALIST_HERO_KAHMU_TEMPLATE = 'Ogek8Jp6Kziz3m9i7Gwi7u9428C' ; VoS
Global Const $FROGGY_ELEMENTALIST_HERO_GOREN_TEMPLATE = 'OQcUERKX1vQXF8E9FViTNAG8V4OA' ; 100b
...
Global Const $FROGGY_ELEMENTALIST_SLOT1_HERO_ID = $ID_ACOLYTE_SOUSUKE
Global Const $FROGGY_ELEMENTALIST_SLOT1_HERO_NAME = 'Sousuke'
Global Const $FROGGY_ELEMENTALIST_SLOT1_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_SOUSUKE_TEMPLATE

Global Const $FROGGY_ELEMENTALIST_SLOT2_HERO_ID = $ID_ZHED_SHADOWHOOF
Global Const $FROGGY_ELEMENTALIST_SLOT2_HERO_NAME = 'Zhed'
Global Const $FROGGY_ELEMENTALIST_SLOT2_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_ZHED_TEMPLATE

Global Const $FROGGY_ELEMENTALIST_SLOT3_HERO_ID = $ID_VEKK
Global Const $FROGGY_ELEMENTALIST_SLOT3_HERO_NAME = 'Vekk'
Global Const $FROGGY_ELEMENTALIST_SLOT3_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_VEKK_TEMPLATE

Global Const $FROGGY_ELEMENTALIST_SLOT4_HERO_ID = $ID_NORGU
Global Const $FROGGY_ELEMENTALIST_SLOT4_HERO_NAME = 'Norgu'
Global Const $FROGGY_ELEMENTALIST_SLOT4_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_NORGU_TEMPLATE
...
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_ID = $ID_TAHLKORA
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_NAME = 'Tahlkora'
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_TAHLKORA_TEMPLATE
...
Global $froggy_no_builds_mode = False

;~ Main method to farm Froggy (no builds variant — preserves custom party and skill bars)
Func FroggyNoBuildsFarm()
	$froggy_no_builds_mode = True
	Local $result = FroggyFarm()
	$froggy_no_builds_mode = False
	Return $result
EndFunc
...
;~ Froggy-specific run failure check: after a wipe, counts how many party
;~ members (player + 7 heroes) are at -60% DP. If at least 4 are maxed out,
;~ the run is considered failed — DP recovery over time is irrelevant.
Func FroggyIsRunFailed()
	If $froggy_max_dp_members_count >= 4 Then
		Notice('At least 4 party members at -60% DP — run considered failed.')
		Return True
	EndIf
	Return False
EndFunc
...
;~ Wait for party to be alive, and if the player died or a wipe happened,
;~ clear all hero flags so they follow from shrine instead of staying flagged
;~ at old fight positions. After a wipe, count how many party members are at
;~ -60% DP for the run-failure check.
Func FroggyWaitUntilPartyAlive()
	Local $wasWiped = IsPlayerAndPartyWiped()
	Local $wasDead = IsPlayerDead()
	WaitUntilPartyAlive()
	If $wasWiped Or $wasDead Then
		CancelAllHeroes()
		If $wasWiped Then FroggyCountMaxDPMembers()
	EndIf
EndFunc


;~ Count how many party members (player + heroes) are at exactly -60% DP.
;~ Stores the result in $froggy_max_dp_members_count.
Func FroggyCountMaxDPMembers()
	Local $count = 0
	For $i = 0 To 7
		If GetMorale($i) <= -60 Then $count += 1
	Next
	$froggy_max_dp_members_count = $count
EndFunc
...
Func SetupFroggyFarm()
	...
	EndIf
	If Not $froggy_no_builds_mode Then
		;~ If SetupFroggyAssassinOverrides() == $FAIL Then Return $FAIL
		If SetupFroggyElementalistOverrides() == $FAIL Then Return $FAIL
		ForceFroggyElementalistWeaponSet()
	Else
		Info('Froggy no-builds: skipping player and hero template loading')
		Info('Froggy no-builds: preserving custom party (' & GetPartySize() & ' members, ' & GetHeroCount() & ' heroes)')
	EndIf
...
Func SetupFroggyElementalistOverrides()
	...
	Info('Froggy Elementalist mode: weapon set 3, skipping build loads')
...
Func RunToBogroot()
	...
	Return FroggyIsRunFailed() ? $FAIL : $SUCCESS
EndFunc
...
Func ClearFroggyFloor1()
	...
	While Not FroggyIsRunFailed() And Not IsAgentInRange(GetMyAgent(), 6078, 4483, 1250)
	...
	While Not FroggyIsRunFailed() And Not IsAgentInRange(GetMyAgent(), -1501, -8590, 1250)
	...
	While Not FroggyIsRunFailed() And Not IsAgentInRange(GetMyAgent(), 7171, -17934, 1250)
		...
		MoveTo(7171, -17934)
	WEnd
	If FroggyIsRunFailed() Then Return $FAIL
...
Func ClearFroggyFloor2()
	...
	Local $lastBossAreaMorale = GetMorale()
	While Not FroggyIsRunFailed() And Not IsQuestReward($ID_FROGGY_QUEST)
		If IsPlayerDead() Then
			CancelAllHeroes()
			RandomSleep(1200)
			ContinueLoop
		...
		If GetMorale() < $lastBossAreaMorale Then
			$lastBossAreaMorale = GetMorale()
			$bossAreaPasses = 0
			Warn('Froggy Floor 2: morale dropped in boss area, extending retry window')
			CancelAllHeroes()
			RandomSleep(1800)
			ContinueLoop
		EndIf
