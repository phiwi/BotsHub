...
Global Const $FROGGY_ELEMENTALIST_HERO_NORGU_TEMPLATE = 'OQhkAoC8AGKDNAna6me5gMAH4iB' ; Esurge (SoO)
...
Global Const $FROGGY_ELEMENTALIST_HERO_RAZAH_TEMPLATE = 'OQhkAoC8AGKzJAna6me5gMgG4iB' ; Esurge (SoO)
;~ Global Const $FROGGY_ELEMENTALIST_HERO_MOW_TEMPLATE = 'OANDYbzfRxVNgeETffEaRVV1DA' ; Healer's Boon
Global Const $FROGGY_ELEMENTALIST_HERO_XANDRA_TEMPLATE = 'OACiAyk8gNdmWvHX4Eae2QuA' ; ST (SoO)
...
Global Const $FROGGY_ELEMENTALIST_HERO_OLIAS_TEMPLATE = 'OAhkQoG4hEyzdoqe9EeSzJ3ws6B' ; BiP (SoO)
Global Const $FROGGY_ELEMENTALIST_HERO_LIVIA_TEMPLATE = 'OANDUshvSxMVBoBnObhaR1DBEA' ; Death Prot (SoO)
Global Const $FROGGY_ELEMENTALIST_HERO_OGDEN_TEMPLATE = 'OwAS4YIP+s7B13lgX7iXkqP' ; RoJ + Command (SoO)
...
; Froggy Elementalist team mirrors the active SoO team (incl. SoO builds):
; Gwen, Norgu, Razah, Xandra, Olias, Livia, Ogden.
...
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_ID = $ID_LIVIA
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_NAME = 'Livia'
Global Const $FROGGY_ELEMENTALIST_SLOT6_HERO_TEMPLATE = $FROGGY_ELEMENTALIST_HERO_LIVIA_TEMPLATE
