...
;~ Global Const $VOLTAIC_HERO_GWEN_TEMPLATE = 'OQhkAsC8gFKzJIHM9MdjQcaG4iB' ; ESurge
Global Const $VOLTAIC_HERO_GWEN_TEMPLATE = 'OQBDAZwTSvAIgcQ5ZkAjQ9UEBA' ; Inep
...
Global Const $VOLTAIC_HERO_NORGU_TEMPLATE = 'OQJUAUBPOMNnAcqpb6lDyADhrDA' ; Esurge + FS
...
Global Const $VOLTAIC_HERO_RAZAH_TEMPLATE = 'OQhkAoC8AGKzJAna6me5gMwQ4iB' ; Esurge
...
;~ Global Const $VOLTAIC_HERO_LIVIA_TEMPLATE = 'OANDUshtS1MUBfBGNTfSEVVbhA' ; Bone Fiends + Healing
Global Const $VOLTAIC_HERO_LIVIA_TEMPLATE = 'OABDUshnSLVUBYBfBWClBVVbhA' ; Bone Fiends + Curses
;~ Global Const $VOLTAIC_HERO_ZHED_TEMPLATE = 'OgNDgLjtShDXVfDLgeDTfGNSEA' ; BSurge + Heal
Global Const $VOLTAIC_HERO_ZHED_TEMPLATE = 'OgNDgMjvOhjr63wboDDI3VtI' ; BSurge + Prot
