...
Global Const $ID_PLANT_FIBER					= 934
...
Global Const $BASIC_MATERIALS_ARRAY[]			= [$ID_BONE, $ID_IRON_INGOT, $ID_TANNED_HIDE_SQUARE, $ID_SCALE, $ID_CHITIN_FRAGMENT, $ID_BOLT_OF_CLOTH, _
													$ID_WOOD_PLANK, $ID_GRANITE_SLAB, $ID_PILE_OF_GLITTERING_DUST, $ID_PLANT_FIBER, $ID_FEATHER]
...
Global Const $MATERIALS_DOUBLE_ARRAY[][]		= [	[$ID_BONE, 1], [$ID_IRON_INGOT, 2], [$ID_TANNED_HIDE_SQUARE, 3], [$ID_SCALE, 4], [$ID_CHITIN_FRAGMENT, 5], [$ID_BOLT_OF_CLOTH, 6], _
													[$ID_WOOD_PLANK, 7], [$ID_GRANITE_SLAB, 9], [$ID_PILE_OF_GLITTERING_DUST, 10], [$ID_PLANT_FIBER, 11], [$ID_FEATHER, 12], _
...
; For pickup use - Minor (1pt), Major (3pt), Superior (50pt)
Global Const $MINOR_ALCOHOLS_ARRAY[]	= [$ID_HUNTERS_ALE, $ID_DWARVEN_ALE, $ID_WITCHS_BREW, $ID_VIAL_OF_ABSINTHE, $ID_EGGNOG, $ID_BOTTLE_OF_RICE_WINE, $ID_ZEHTUKAS_JUG, _
												$ID_BOTTLE_OF_JUNIBERRY_GIN, $ID_BOTTLE_OF_VABBIAN_WINE, $ID_SHAMROCK_ALE, $ID_HARD_APPLE_CIDER]
Global Const $MAJOR_ALCOHOLS_ARRAY[]	= [$ID_FLASK_OF_FIREWATER, $ID_SPIKED_EGGNOG, $ID_AGED_DWARVEN_ALE, $ID_BOTTLE_OF_GROG, $ID_AGED_HUNTERS_ALE, $ID_KEG_OF_AGED_HUNTERS_ALE, $ID_KRYTAN_BRANDY]
Global Const $SUPERIOR_ALCOHOLS_ARRAY[]	= [$ID_BATTLE_ISLE_ICED_TEA]
Global Const $MAP_ALCOHOLS				= MapFromArray($ALCOHOLS_ARRAY)
Global Const $MAP_MINOR_ALCOHOLS		= MapFromArray($MINOR_ALCOHOLS_ARRAY)
Global Const $MAP_MAJOR_ALCOHOLS		= MapFromArray($MAJOR_ALCOHOLS_ARRAY)
Global Const $MAP_SUPERIOR_ALCOHOLS		= MapFromArray($SUPERIOR_ALCOHOLS_ARRAY)
#EndRegion Alcohol
...
Global Const $ID_EL_JORA_TONIC					= 36445
...
; For pickup use - Minor (1-2pt), Major (3-7pt), Superior (25-50pt)
Global Const $MINOR_PARTY_ARRAY[]		= [$ID_GHOST_IN_THE_BOX, $ID_SQUASH_SERUM, $ID_SNOWMAN_SUMMONER, $ID_BOTTLE_ROCKET, $ID_CHAMPAGNE_POPPER, $ID_SPARKLER, _
											$ID_SINISTER_AUTOMATONIC_TONIC, $ID_TRANSMOGRIFIER_TONIC, $ID_YULETIDE_TONIC, $ID_BEETLE_JUICE_TONIC, $ID_ABYSSAL_TONIC, _
											$ID_CEREBRAL_TONIC, $ID_MACABRE_TONIC, $ID_TRAPDOOR_TONIC, $ID_SEARING_TONIC, $ID_AUTOMATONIC_TONIC, $ID_SKELETONIC_TONIC, _
											$ID_BOREAL_TONIC, $ID_GELATINOUS_TONIC, $ID_PHANTASMAL_TONIC, $ID_ABOMINABLE_TONIC, $ID_FROSTY_TONIC, $ID_MISCHIEVIOUS_TONIC, _
											$ID_COTTONTAIL_TONIC, $ID_UNSEEN_TONIC]
Global Const $MAJOR_PARTY_ARRAY[]		= [$ID_CRATE_OF_FIREWORKS, $ID_ZAISHEN_TONIC, $ID_MINUTELY_MAD_KING_TONIC, $ID_MYSTERIOUS_TONIC, $ID_DISCO_BALL]
Global Const $SUPERIOR_PARTY_ARRAY[]	= [$ID_SPOOKY_TONIC, $ID_PARTY_BEACON]
Global Const $MAP_MINOR_PARTY			= MapFromArray($MINOR_PARTY_ARRAY)
Global Const $MAP_MAJOR_PARTY			= MapFromArray($MAJOR_PARTY_ARRAY)
Global Const $MAP_SUPERIOR_PARTY		= MapFromArray($SUPERIOR_PARTY_ARRAY)
#EndRegion Party
...
; For pickup use - Minor (1-2pt), Major (3-7pt), Superior (50pt) - excludes Pcons
Global Const $MINOR_SWEETS_ARRAY[]		= [$ID_FRUITCAKE, $ID_MANDRAGOR_ROOT_CAKE, $ID_SUGARY_BLUE_DRINK, $ID_CHOCOLATE_BUNNY, $ID_JAR_OF_HONEY, $ID_RED_BEAN_CAKE]
Global Const $MAJOR_SWEETS_ARRAY[]		= [$ID_CREME_BRULEE, $ID_KRYTAN_LOKUM, $ID_MINITREATS_OF_PURITY]
Global Const $SUPERIOR_SWEETS_ARRAY[]	= [$ID_DELICIOUS_CAKE]
Global Const $MAP_MINOR_SWEETS			= MapFromArray($MINOR_SWEETS_ARRAY)
Global Const $MAP_MAJOR_SWEETS			= MapFromArray($MAJOR_SWEETS_ARRAY)
Global Const $MAP_SUPERIOR_SWEETS		= MapFromArray($SUPERIOR_SWEETS_ARRAY)
...
Global Const $ID_ANNIVERSARY_SHORTBOW_WHISPER			= 999999
Global Const $ID_ANNIVERSARY_DAGGERS_VENGEANCE			= 999999
Global Const $ID_ANNIVERSARY_HAMMER_VERDICT				= 999999
Global Const $ID_ANNIVERSARY_SCYTHE_SUFFERER			= 38026
