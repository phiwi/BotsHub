...
Global Const $TROPHIES_ARRAY[]	= [ _
	...
	$ID_SOUL_STONE, $ID_VERMIN_HIDE, $ID_VENERABLE_MANTID_PINCER, $ID_CELESTIAL_ESSENCE, $ID_ANCIENT_KAPPA_SHELL, $ID_MOON_SHELL, $ID_COPPER_SHILLING, $ID_GOLD_DOUBLOON, $ID_SILVER_BULLION_COIN, _
	...
	$ID_INSECT_CARAPACE, $ID_SENTIENT_LODESTONE, $ID_IMMOLATED_DJINN_ESSENCE, $ID_ROARING_ETHER_CLAW, $ID_MALODOROUS_MASS, $ID_MANDRAGOR_HUSK, $ID_MANDRAGOR_SWAMPROOT, $ID_BEHEMOTH_HIDE, $ID_GEODE, _
...
Global Const $ID_ETERNAL_SHIELD_TACTIC				= 333
...
Global Const $ID_IRIDESCENT_AEGIS_COMMAND				= 2298		; Command
...
Local $ultraRareWeaponsArray = [ _
	...
	$ID_ETERNAL_BOW, _
	$ID_GHOSTLY_STAFF, _
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTIC, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, _
	_
...
Local $rareWeaponsToPickUp = [ _
	...
	_ ; Shields
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTIC, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, _
	$ID_EMBLAZONED_DEFENDER, $ID_EXALTED_AEGIS, _
...
Local $rareWeaponsArray = [ _
	...
	_ ; Shields
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTIC, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, _
	$ID_DEMONIC_AEGIS, $ID_DRACONIC_AEGIS, $ID_EMBLAZONED_DEFENDER, $ID_EXALTED_AEGIS, _
	$ID_AMBER_AEGIS_STRENGTH, $ID_AMBER_AEGIS_TACTICS, $ID_BLADED_SHIELD, $ID_BLADED_SHIELD_2, _
	$ID_ECHOVALD_SHIELD, $ID_ECHOVALD_SHIELD_2, $ID_GOTHIC_DEFENDER, $ID_GOTHIC_DEFENDER_2, $ID_GUARDIAN_OF_THE_HUNT, $ID_GUARDIAN_OF_THE_HUNT_2, _
	$ID_KAPPA_SHIELD, $ID_KAPPA_SHIELD_2, $ID_ORNATE_SHIELD, $ID_PLAGUEBORN_SHIELD, $ID_PLAGUEBORN_SHIELD_2, _
	$ID_OUTCAST_SHIELD, $ID_OUTCAST_SHIELD_2, $ID_SEA_PURSE_SHIELD, _
