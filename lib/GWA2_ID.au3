...
;~ Global Const $GADGETID_ASCALONIAN_CHEST			=
;~ Global Const $GADGETID_STEEL_CHEST				=
;~ Global Const $GADGETID_KRYTAN_CHEST				=
;~ Global Const $GADGETID_MAGUUMA_CHEST				=
;~ Global Const $GADGETID_ELONIAN_CHEST				=
;~ Global Const $GADGETID_SHIVERPEAK_CHEST			=
;~ Global Const $GADGETID_DARKSTONE_CHEST			=
;~ Global Const $GADGETID_MINERS_CHEST				=

Global Const $GADGETID_SHING_JEA_CHEST				= 4579
Global Const $GADGETID_LUXON_CHEST					= 4580
;~ Global Const $GADGETID_CANTHAN_CHEST				=
;~ Global Const $GADGETID_KURZICK_CHEST				=
;~ Global Const $GADGETID_FORBIDDEN_CHEST			=
;~ Global Const $GADGETID_DEEP_JADE_CHEST			=
;~ Global Const $GADGETID_STONEROOT_CHEST			=

Global Const $GADGETID_ANCIENT_ELONIAN_CHEST		= 6061
Global Const $GADGETID_ISTANI_CHEST					= 6062
Global Const $GADGETID_VABBI_CHEST					= 6063
Global Const $GADGETID_KOURNAN_CHEST				= 6064
;~ Global Const $GADGETID_MARGONITE_CHEST			=
;~ Global Const $GADGETID_DEMONIC_CHEST				=
...
;~ Global Const $GADGETID_KANAXAI_CHEST				=

;~ Global Const $GADGETID_TREASURE_CHEST			=
;~ Global Const $GADGETID_STYGIAN_CHEST				=
;~ Global Const $GADGETID_TITAN_CHEST				=
;~ Global Const $GADGETID_TORCQUA_CHEST				=
;~ Global Const $GADGETID_RAVENHEART_CHEST			=
;~ Global Const $GADGETID_CITADEL_CHEST				=

Global Const $GADGETID_BROTHERHOOD_CHEST			= 9157
;~ Global Const $GADGETID_HIDDEN_TREASURE_CHEST		=
;~ Global Const $GADGETID_UNLIT_TORCH_CHEST			=
;~ Global Const $GADGETID_WINTERSDAY_CHEST			=
;~ Global Const $GADGETID_ARACHNIS_SPOILS			=
;~ Global Const $GADGETID_BOGROOT_CHEST				=
;~ Global Const $GADGETID_CHEST_OF_BURROWS			=
;~ Global Const $GADGETID_CHEST_OF_KATHANDRAX		=
;~ Global Const $GADGETID_CHEST_OF_WINTERSDAY_PAST	=
;~ Global Const $GADGETID_DESTROYER_CHEST			=
;~ Global Const $GADGETID_DRAGRIMMAR_CHEST			=
;~ Global Const $GADGETID_ELDRITCH_CHEST			=
;~ Global Const $GADGETID_FENDIS_CHEST				=
;~ Global Const $GADGETID_HAVOKS_CHEST				=
;~ Global Const $GADGETID_HIDESPLITTERS_CHEST		=
;~ Global Const $GADGETID_IRONTOES_CHEST			=
;~ Global Const $GADGETID_MOUNTAIN_HEART_CHEST		=
;~ Global Const $GADGETID_MURAKAIS_CHEST			=
;~ Global Const $GADGETID_OOLAS_CHEST				=
;~ Global Const $GADGETID_PRISMATIC_CHEST			=
;~ Global Const $GADGETID_ZOLDARKS_CHEST			=
;~ Global Const $GADGETID_CHEST_OF_THE_SLAVER		=
;~ Global Const $GADGETID_HIEROPHANTS_CHEST			=

Global Const $CHESTS_ARRAY[]					= [ _
	$GADGETID_NM_CHEST, $GADGETID_HM_CHEST, _
	$GADGETID_ANCIENT_ELONIAN_CHEST, $GADGETID_ISTANI_CHEST, $GADGETID_VABBI_CHEST, $GADGETID_KOURNAN_CHEST, _
	$GADGETID_SHING_JEA_CHEST, $GADGETID_LUXON_CHEST, _
	$GADGETID_OBSIDIAN_CHEST, $GADGETID_PHANTOM_CHEST _
]
