...
Global Const $CHESTS_ARRAY[]				= [$GADGETID_ISTANI_CHEST, $GADGETID_SHING_JEA_CHEST, $GADGETID_NM_CHEST, $GADGETID_HM_CHEST, $GADGETID_OBSIDIAN_CHEST, $GADGETID_PHANTOM_CHEST, $GADGETID_KOURNAN_CHEST, $GADGETID_BROTHERHOOD_CHEST]
Global Const $MAP_CHESTS_IDS				= MapFromArray($CHESTS_ARRAY)Global Const $GADGETID_ANCIENT_ELONIAN_CHEST	= 6061
Global Const $GADGETID_ISTANI_CHEST				= 6062
Global Const $GADGETID_VABBI_CHEST				= 6063
Global Const $GADGETID_KOURNAN_CHEST			= 6064
Global Const $GADGETID_SHING_JEA_CHEST			= 4579
...
Global Const $GADGETID_PHANTOM_CHEST			= 68
Global Const $GADGETID_BROTHERHOOD_CHEST		= 9157
Global Const $CHESTS_ARRAY[]					= [$GADGETID_ANCIENT_ELONIAN_CHEST, $GADGETID_ISTANI_CHEST, $GADGETID_VABBI_CHEST, $GADGETID_KOURNAN_CHEST, $GADGETID_SHING_JEA_CHEST, $GADGETID_NM_CHEST, $GADGETID_HM_CHEST, $GADGETID_OBSIDIAN_CHEST, $GADGETID_PHANTOM_CHEST]
